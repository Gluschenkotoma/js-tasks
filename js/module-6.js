...
// // (7) ["приключения", "историческое", "фантастика", "мистика", "ужасы", "мистика", "приключения"]
// // (5)["приключения", "историческое", "фантастика", "мистика", "ужасы"]
...
// 'Padilla Garrison', 'Naomi Buckner', 'Goldie Gentry', 'Aisha Tran', 'Jordan Sampson', 'Eddie Strong', 'Jacklyn Lucas', 'Linda Chapman'].
// Вызов функции со случайными, но валидными аргументами, возвращает правильное значение.
...
// Если значение параметра email это c, функция возвращает объект пользователя с именем Sheree Anthony.
...
// Значение параметра users не изменяется.
// Вызов функции с указанным массивом пользователей возвращает массив ['Adrian Cross', 'Aisha Tran', 'Briana Decker', 'Eddie Strong', 'Goldie Gentry', 'Jacklyn Lucas',
